// Copied from HR/EmailList.jsx and stripped of HR badges
const PersonalEmailList = ({ emails, loading, onSelectEmail, selectedId, highlightQuery }) => {
                    ...
                    >
                        <div className="flex items-start justify-between gap-3">
                            <div className="flex-1 min-w-0">
                                ...
                                {/* Badges - STRIPPED of HR Applicant status */}
                                <div className="flex gap-2 mt-2 flex-wrap items-center">
                                    ...
                                    {/* REMOVED: ConversionStatus, Applicant Badge */}
                                </div>
                            </div>
...
export default PersonalEmailList;
